...
const NavbarElement = (props : propsType) => {
  return (
    <Link href={props.link} className='flex w-full group/element gap-2 border-b-2 border-gray-200 p-3 px-5 text-black text-nowrap items-center justify-between text-sm hover:text-[#784afe] transition-all duration-300 ease-in-out'>
