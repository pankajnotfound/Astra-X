...
const Hero = (props:propsType) => {
  return (
    <div className='w-full h-fit relative flex justify-center items-center overflow-hidden border-y-1 border-gray-300 '>
      ...
      <div className='flex flex-col justify-center items-center gap-8 px-2 py-7 lg:py-25'>
        <p className='z-1 text-5xl font-bold'>{props.info.HeroText}</p>
        <div className='w-fit flex justify-center items-center gap-2 text-center '>
          ...
          <p className='text-[#784afe] font-bold '>{props.info.HeroText}</p>
        </div>
      </div>
      <div>
